...
module.exports = {
  getAllData: async (req, res) => {
    ...
    try {
      const getAllData = await sequelize.query(
        `SELECT * FROM public.types_of_expense ORDER BY created_datetime DESC${
      ...
      const getCount = await sequelize.query(
        `SELECT COUNT(id) FROM public.types_of_expense;`,
        {
          type: QueryTypes.SELECT,
        }
      );
  ...
  getSpecificData: async (req, res) => {
    ...
    try {
      const getSpecificData = await sequelize.query(
        `SELECT * FROM public.types_of_expense WHERE id = '${id}';`,
        {
          bind: { id },
          type: QueryTypes.SELECT,
        }
  ...
  createData: async (req, res) => {
    ...
    try {
      await sequelize.query(
        `INSERT INTO public.types_of_expense (id, name, created_datetime, updated_datetime)
  ...
  updateData: async (req, res) => {
    ...
    try {
      await sequelize.query(
        `UPDATE public.types_of_expense SET name = $name, updated_datetime = $updated_datetime
  ...
  deleteData: async (req, res) => {
    ...
    try {
      await sequelize.query(
        `DELETE FROM public.types_of_expense WHERE id = '${id}' RETURNING *;`,
        {
          bind: { id },
